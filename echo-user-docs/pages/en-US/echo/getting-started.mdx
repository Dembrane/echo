...
>
  <iframe
    src="https://www.loom.com/embed/41e897ccc1f74ee183e0ce515fa01cf8?sid=3539afb3-217f-4224-aada-6249d2e46f45"
    frameBorder={0}
...
### 1. [Create Project and configure the portal](getting-started/creating-project)
...
### 2. [Collect Data](getting-started/collecting-data)
   ...
   - Make sure the phone stays active during the recording (black screen = no recording)


### 3. [Analyze Data](getting-started/analysis)

   - Use the "Ask" feature to explore your data and gain insights
   - Use "Library" to get AI-clustered overviews
   - Use the "Report" feature to easily share what the conversation was about with participants and a wider public.
...
Need help? Contact evelien@dembrane.com
