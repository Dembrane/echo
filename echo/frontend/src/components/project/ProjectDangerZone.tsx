    ...
    >
      <>
          ...
          <Stack gap="md">
            <Text size="sm">
              <Trans>
                ...
                and tags are copied. Reports, chats and conversations are not included
                in the clone. You will be redirected to the new project after cloning.
              </Trans>
            </Text>
            ...
            {!cloneProjectByIdMutation.isPending && cloneProjectByIdMutation.error && (
              <>
              <Alert title={t`Error cloning project`} color="red" variant="light">
                <Trans>
                  There was an error cloning your project. Please try again or contact support.
                </Trans>
              </Alert>
              </>
            )}
        ...
        >
          <Stack gap="md">
            <Text size="sm">
              <Trans>Are you sure you want to delete this project? This action cannot be undone.</Trans>
            </Text>
          </Stack>
          <Group justify="flex-end">
