				...
				{(linkingConversation?.source_conversation_id as Conversation)?.id && (
					<>
						...
						<ConversationAnchor
							...
							to={`/w/${workspaceId}/projects/${projectId}/conversation/${(linkingConversation?.source_conversation_id as Conversation)?.id}/overview`}
							name={
							...
							(conversationLink: ConversationLink) =>
								(conversationLink?.target_conversation_id as Conversation)
									...
									<List.Item key={conversationLink?.id}>
										<ConversationAnchor
											to={`/w/${workspaceId}/projects/${projectId}/conversation/${(conversationLink?.target_conversation_id as Conversation)?.id}/overview`}
											name={
												(
													conversationLink?.target_conversation_id as Conversation
												)?.participant_name ?? ""
