...
- The job the missing feature should do.
- The moment where the host needs it.
- What workaround would be acceptable for now.
- Any exact wording from the host that explains the need.
- Whether the host consents to sending this to the dembrane team.

Never send anything to the team without consent. If the host consents, restate what will be sent first.
