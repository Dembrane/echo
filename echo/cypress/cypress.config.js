		...
		setupNodeEvents(on, config) {
			...
			on("before:browser:launch", (browser = {}, launchOptions) => {
				...
				if (browser.family === "chromium" || browser.name === "chrome") {
					...
					launchOptions.args.push(
						"--use-file-for-fake-audio-capture=c:/Users/charu/OneDrive/Desktop/echo/echo/cypress/fixtures/test-audio.wav",
					);
				...
				if (browser.family === "firefox") {
					...
					launchOptions.preferences["media.navigator.permission.disabled"] =
						true;
