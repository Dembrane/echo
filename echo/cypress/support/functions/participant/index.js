	...
	const clickNext = (attempt = 0) => {
		...
		cy.get("body").then(($body) => {
			if ($body.find('[data-testid="portal-onboarding-checkbox"]').length > 0) {
				...
				cy.get('[data-testid="portal-onboarding-next-button"]')
					.should("be.visible")
					.click();
				cy.wait(1000);
				clickNext(attempt + 1);
...
export const clickThroughOnboardingUntilMicrophone = (maxAttempts = 10) => {
	const clickNext = (attempt = 0) => {
		...
		cy.get("body").then(($body) => {
			if (
				$body.find('[data-testid="portal-onboarding-mic-skip-button"]').length >
				0
			) {
...
export const clickOnboardingBack = () => {
	...
	cy.get('[data-testid="portal-onboarding-back-button"]')
		.should("be.visible")
		.click();
};
...
export const continueMicrophoneCheck = ({ allowSkip = false } = {}) => {
	...
	cy.get('[data-testid="portal-onboarding-mic-continue-button"]', {
		timeout: 10000,
	})
		.should("be.visible")
		.click();
...
export const backFromMicrophoneCheck = () => {
	...
	cy.get('[data-testid="portal-onboarding-mic-back-button"]')
		.should("be.visible")
		.click();
};
...
export const verifyAndSelectTag = (tagName) => {
	...
	cy.get('[data-combobox-option="true"]:visible').then(($options) => {
		const $matchingOptions = normalizedTagName
			? $options.filter(
					(_, option) => Cypress.$(option).text().trim() === normalizedTagName,
				)
			: Cypress.$();

		const $targetOption =
			$matchingOptions.length > 0 ? $matchingOptions.first() : $options.first();
...
export const stopRecording = () => {
	...
	cy.get("body", { timeout: 30000 }).then(($body) => {
		...
		if (
			$body.find('[data-testid="portal-audio-stop-button"]:visible').length > 0
		) {
			...
			$body.find(
				'[data-testid="portal-audio-interruption-reconnect-button"]:visible',
			).length > 0
		) {
...
export const handleRecordingInterruption = () => {
	...
	cy.get("body").then(($body) => {
		if (
			$body.find('[data-testid="portal-audio-interruption-reconnect-button"]')
				.length > 0
		) {
			...
			cy.get("body").then(($bodyAfter) => {
				if (
					$bodyAfter.find('[data-testid="portal-audio-record-button"]:visible')
						.length > 0
				) {
...
export const resumeRecording = () => {
	...
	cy.get('[data-testid="portal-audio-stop-resume-button"]')
		.should("be.visible")
		.click();
};
...
export const finishFromPause = () => {
	...
	cy.get('[data-testid="portal-audio-stop-finish-button"]')
		.should("be.visible")
		.click();
	cy.wait(2000);
};
...
export const clickEchoButton = () => {
	...
	cy.get('[data-testid="portal-audio-echo-button"]')
		.should("be.visible")
		.click();
};
...
export const switchToTextMode = () => {
	...
	cy.get('[data-testid="portal-audio-switch-to-text-button"]')
		.should("be.visible")
		.click();
};
...
export const closeEchoInfoModal = () => {
	...
	cy.get('[data-testid="portal-audio-echo-info-close-button"]')
		.should("be.visible")
		.click();
};
...
export const submitText = () => {
	...
	cy.get('[data-testid="portal-text-submit-button"]')
		.should("be.visible")
		.click();
};
...
export const switchToAudioMode = () => {
	...
	cy.get('[data-testid="portal-text-switch-to-audio-button"]')
		.should("be.visible")
		.click();
};
...
export const finishTextMode = () => {
	...
	cy.get('[data-testid="portal-text-finish-button"]')
		.should("be.visible")
		.click();
};
...
export const confirmFinishText = () => {
	...
	cy.get('[data-testid="portal-text-finish-confirm-button"]')
		.should("be.visible")
		.click();
};
...
export const cancelFinishText = () => {
	...
	cy.get('[data-testid="portal-text-finish-cancel-button"]')
		.should("be.visible")
		.click();
};
...
export const selectMakeItConcrete = () => {
	...
	cy.get('[data-testid="portal-echo-verify-card"]')
		.should("be.visible")
		.click();
};
...
export const selectMakeItDeeper = () => {
	cy.log("Selecting Make it Concrete");
	cy.get('[data-testid="portal-echo-explore-card"]')
		.should("be.visible")
		.click();
};
...
export const waitForExploreResponse = (timeout = 30000) => {
	...
	cy.get('[data-testid="portal-explore-thinking"]', { timeout }).should(
		"not.exist",
	);
...
export const selectVerifyTopic = (topicKey) => {
	...
	cy.get(`[data-testid="portal-verify-topic-${topicKey}"]`)
		.should("be.visible")
		.click();
};
...
export const proceedFromTopicSelection = () => {
	...
	cy.get('[data-testid="portal-verify-selection-next-button"]')
		.should("be.visible")
		.click();
};
...
export const proceedFromInstructions = () => {
	...
	cy.get('[data-testid="portal-verify-instructions-next-button"]')
		.should("be.visible")
		.click();
};
...
export const readArtefactAloud = () => {
	...
	cy.get('[data-testid="portal-verify-artefact-read-aloud-button"]')
		.should("be.visible")
		.click();
};
...
export const reviseArtefact = () => {
	...
	cy.get('[data-testid="portal-verify-artefact-revise-button"]')
		.should("be.visible")
		.click();
};
...
export const editArtefact = () => {
	...
	cy.get('[data-testid="portal-verify-artefact-edit-button"]')
		.should("be.visible")
		.click();
};
...
export const approveArtefact = () => {
	...
	cy.get('[data-testid="portal-verify-artefact-approve-button"]')
		.should("be.visible")
		.click();
};
...
export const saveArtefactEdit = () => {
	...
	cy.get('[data-testid="portal-verify-artefact-save-edit-button"]')
		.should("be.visible")
		.click();
};
...
export const cancelArtefactEdit = () => {
	...
	cy.get('[data-testid="portal-verify-artefact-cancel-edit-button"]')
		.should("be.visible")
		.click();
};
...
export const viewResponses = () => {
	...
	cy.get('[data-testid="portal-view-responses-button"]')
		.should("be.visible")
		.click();
};
...
export const clickPortalBack = () => {
	...
	cy.get('[data-testid="portal-header-back-button"]')
		.should("be.visible")
		.click();
};
...
export const clickPortalCancel = () => {
	...
	cy.get('[data-testid="portal-header-cancel-button"]')
		.should("be.visible")
		.click();
};
...
export const openPortalSettings = () => {
	...
	cy.get('[data-testid="portal-header-settings-button"]')
		.should("be.visible")
		.click();
...
export const selectMicrophone = (micName) => {
	...
	cy.get('[data-testid="portal-settings-mic-select"]')
		.should("be.visible")
		.select(micName);
};
...
export const verifyMicrophoneWorking = () => {
	...
	cy.get('[data-testid="portal-settings-mic-success-alert"]').should(
		"be.visible",
	);
};
...
export const verifyMicrophoneIssue = () => {
	...
	cy.get('[data-testid="portal-settings-mic-issue-alert"]').should(
		"be.visible",
	);
};
...
export const confirmMicrophoneChange = () => {
	...
	cy.get('[data-testid="portal-settings-mic-change-confirm-button"]')
		.should("be.visible")
		.click();
};
...
export const cancelMicrophoneChange = () => {
	...
	cy.get('[data-testid="portal-settings-mic-change-cancel-button"]')
		.should("be.visible")
		.click();
};
...
export const submitEmailNotification = () => {
	...
	cy.get('[data-testid="portal-finish-email-submit-button"]')
		.should("be.visible")
		.click();
};
 ...
 */
export const installParticipantAudioStubs = ({
	audioBase64,
	...
	cy.on("window:before:load", (win) => {
		...
		const createAnalyserStub = () => {
			...
			analyser.frequencyBinCount = Math.max(
				1,
				Math.floor(analyser._fftSize / 2),
			);
		...
		const ensureAudioContextCtor = () => {
			...
			if (typeof win.AudioContext.prototype.createAnalyser !== "function") {
				win.AudioContext.prototype.createAnalyser = () => createAnalyserStub();
			}

			if (
				typeof win.AudioContext.prototype.createMediaStreamSource !== "function"
			) {
				win.AudioContext.prototype.createMediaStreamSource = () => ({
					connect() {},
					disconnect() {},
				});
			}
			...
			if (
				typeof win.AudioContext.prototype.createMediaStreamDestination !==
				"function"
			) {
				win.AudioContext.prototype.createMediaStreamDestination = () => {
			...
			if (
				typeof win.AudioContext.prototype.createMediaElementSource !==
				"function"
			) {
				win.AudioContext.prototype.createMediaElementSource = () => ({
					connect() {},
					disconnect() {},
				});
			}
			...
			if (typeof win.AudioContext.prototype.createOscillator !== "function") {
				win.AudioContext.prototype.createOscillator = () => ({
					connect() {},
					disconnect() {},
					frequency: { value: 440 },
					start() {},
			...
			if (
				typeof win.AudioContext.prototype.createScriptProcessor !== "function"
			) {
				win.AudioContext.prototype.createScriptProcessor = () => ({
					connect() {},
					disconnect() {},
					onaudioprocess: null,
				});
			...
			if (typeof win.AudioContext.prototype.close !== "function") {
				win.AudioContext.prototype.close = () => Promise.resolve();
			}

			if (typeof win.AudioContext.prototype.resume !== "function") {
				win.AudioContext.prototype.resume = () => Promise.resolve();
			}

			if (typeof win.AudioContext.prototype.suspend !== "function") {
				win.AudioContext.prototype.suspend = () => Promise.resolve();
			}
		};
		...
		const patchAudioContext = (AudioContextCtor) => {
			...
			if (typeof originalCreateAnalyser !== "function") {
				AudioContextCtor.prototype.createAnalyser = () => createAnalyserStub();
				return;
			}
			...
			if (
				typeof AudioContextCtor.prototype.createMediaStreamDestination !==
				"function"
			) {
				AudioContextCtor.prototype.createMediaStreamDestination = () => {
					ensureMediaStreamCtor();
		...
		const audioDataUrl = audioBase64
		...
		const getRecordingBlob = () => {
			...
			if (audioBase64) {
				try {
					...
					win.__cypressAudioBlob = new Blob([bytes], {
		...
		const installMediaRecorderStub = () => {
			...
			if (
				...
				!(Cypress.browser && Cypress.browser.name === "webkit")
			) {
				return;
			}
			...
			CypressMediaRecorder.isTypeSupported = (mimeType) =>
				mimeType === "audio/wav" || mimeType === audioMimeType;
		...
		const applyMediaStubs = () => {
			...
			if (win.navigator.permissions) {
				...
				safeDefine(win.navigator.permissions, "query", permissionsQuery);
			...
			const patchMediaDevices = (target) => {
				...
				safeDefine(target, "enumerateDevices", () =>
					Promise.resolve(fallbackDevices),
				);

				safeDefine(target, "getUserMedia", () => {
					win.__cypressMicPermissionGranted = true;
					return Promise.resolve(getForcedStream());
				});
			};
			...
			safeDefine(win.navigator, "getUserMedia", (..._args) => {
				win.__cypressMicPermissionGranted = true;
				return Promise.resolve(getForcedStream());
			});

			safeDefine(win.navigator, "webkitGetUserMedia", (..._args) => {
				win.__cypressMicPermissionGranted = true;
				return Promise.resolve(getForcedStream());
			});
...
export const confirmFinishConversation = () => {
	...
	cy.get("body").then(($body) => {
		if (
			$body.text().includes("Finish Conversation") ||
