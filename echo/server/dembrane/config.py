...
logger.debug(f"LIGHTRAG_LITELLM_TEXTSTRUCTUREMODEL_MODEL: {LIGHTRAG_LITELLM_TEXTSTRUCTUREMODEL_MODEL}")
...
logger.debug(f"LIGHTRAG_LITELLM_TEXTSTRUCTUREMODEL_API_BASE: {LIGHTRAG_LITELLM_TEXTSTRUCTUREMODEL_API_BASE}")
...
logger.debug(f"LIGHTRAG_LITELLM_TEXTSTRUCTUREMODEL_API_VERSION: {LIGHTRAG_LITELLM_TEXTSTRUCTUREMODEL_API_VERSION}")
...
if LIGHTRAG_LITELLM_INFERENCE_API_VERSION:
    logger.debug(f"LIGHTRAG_LITELLM_INFERENCE_API_VERSION: {LIGHTRAG_LITELLM_INFERENCE_API_VERSION}")
else:
