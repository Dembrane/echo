...
QUOTEUTIL_LITELLM_MODEL = os.environ.get("QUOTEUTIL_LITELLM_MODEL")  # azure/gpt-4o-mini
assert QUOTEUTIL_LITELLM_MODEL, "QUOTEUTIL_LITELLM_MODEL environment variable is not set"
logger.debug(f"QUOTEUTIL_LITELLM_MODEL: {QUOTEUTIL_LITELLM_MODEL}")

QUOTEUTIL_LITELLM_API_KEY = os.environ.get("QUOTEUTIL_LITELLM_API_KEY")
assert QUOTEUTIL_LITELLM_API_KEY, "QUOTEUTIL_LITELLM_API_KEY environment variable is not set"
logger.debug("QUOTEUTIL_LITELLM_API_KEY: set")

QUOTEUTIL_LITELLM_API_VERSION = os.environ.get("QUOTEUTIL_LITELLM_API_VERSION")
assert QUOTEUTIL_LITELLM_API_VERSION, "QUOTEUTIL_LITELLM_API_VERSION environment variable is not set"
logger.debug(f"QUOTEUTIL_LITELLM_API_VERSION: {QUOTEUTIL_LITELLM_API_VERSION}")

QUOTEUTIL_LITELLM_API_BASE = os.environ.get("QUOTEUTIL_LITELLM_API_BASE")
assert QUOTEUTIL_LITELLM_API_BASE, "QUOTEUTIL_LITELLM_API_BASE environment variable is not set"
logger.debug(f"QUOTEUTIL_LITELLM_API_BASE: {QUOTEUTIL_LITELLM_API_BASE}")
