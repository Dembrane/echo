...
ENABLE_ENGLISH_TRANSCRIPTION_WITH_LITELLM = os.environ.get("ENABLE_ENGLISH_TRANSCRIPTION_WITH_LITELLM", "false").lower() in ["true", "1"]
assert ENABLE_ENGLISH_TRANSCRIPTION_WITH_LITELLM, "ENABLE_ENGLISH_TRANSCRIPTION_WITH_LITELLM environment variable is not set"
logger.debug(f"ENABLE_ENGLISH_TRANSCRIPTION_WITH_LITELLM: {ENABLE_ENGLISH_TRANSCRIPTION_WITH_LITELLM}")  
...
if ENABLE_RUNPOD_WHISPER_TRANSCRIPTION:
    assert RUNPOD_WHISPER_PRIORITY_BASE_URL, "RUNPOD_WHISPER_PRIORITY_BASE_URL environment variable is not set"
    logger.debug(f"RUNPOD_WHISPER_PRIORITY_BASE_URL: {RUNPOD_WHISPER_PRIORITY_BASE_URL}")

RUNPOD_WHISPER_MAX_REQUEST_THRESHOLD = int(str(os.environ.get("RUNPOD_WHISPER_MAX_REQUEST_THRESHOLD")))
if ENABLE_RUNPOD_WHISPER_TRANSCRIPTION:
    assert RUNPOD_WHISPER_MAX_REQUEST_THRESHOLD, "RUNPOD_WHISPER_MAX_REQUEST_THRESHOLD environment variable is not set"
