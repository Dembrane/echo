...
ENABLE_RUNPOD_WHISPER_TRANSCRIPTION = os.environ.get("ENABLE_RUNPOD_WHISPER_TRANSCRIPTION", "false").lower() in ["true", "1"]
...
RUNPOD_WHISPER_MODEL = os.environ.get("RUNPOD_WHISPER_MODEL")
if ENABLE_RUNPOD_WHISPER_TRANSCRIPTION: 
    assert RUNPOD_WHISPER_MODEL, "RUNPOD_WHISPER_MODEL environment variable is not set"
logger.debug(f"RUNPOD_WHISPER_MODEL: {RUNPOD_WHISPER_MODEL}")
...
ENABLE_LITELLM_WHISPER_TRANSCRIPTION = os.environ.get("ENABLE_LITELLM_WHISPER_TRANSCRIPTION", "false").lower() in ["true", "1"]
