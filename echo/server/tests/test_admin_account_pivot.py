...
def test_five_seat_changemaker_annual_matches_monthly_equivalent():
    ...
    # Monthly cadence bills the +15% surcharge each month (MONTHLY_BILLING_PREMIUM_PCT,
    # 20% -> 15% in #689): €75 × 1.15 × 5 = €431.25, rounded to whole euros → €430.
    assert _account_monthly_forecast("changemaker", 5, "monthly", None) == 430.0
