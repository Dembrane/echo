/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eef6645adf2244e5414be8bd964ba127)
// Runtime types generated with workerd@1.20260921.1 2026-09-23
interface __BaseEnv_Env {
	DIRECTUS_URL: string;
	DIRECTUS_PUBLIC_URL: string;
	DIRECTUS_SESSION_COOKIE: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "User" | "Project" | "Directory";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIRECTUS_URL" | "DIRECTUS_SECRET" | "DIRECTUS_TOKEN">> {}
}
